  ...
  group('M3ColorUtils', () {
    group('Color Manipulation', () {
      ...
      test('saturate increases saturation', () {
        ...
        expect(saturatedHsl.saturation, 
            greaterThan(originalHsl.saturation));
      });
      ...
      test('desaturate decreases saturation', () {
        ...
        expect(desaturatedHsl.saturation, 
            lessThan(originalHsl.saturation));
      });
      ...
      test('color manipulation methods clamp values correctly', () {
        ...
        final overlightened = M3ColorUtils.lighten(color, 2.0);
        expect(overlightened, equals(Colors.white));
        
        // Should not go below 0.0 lightness
        const darkColor = Colors.black;
        final overdarkened = M3ColorUtils.darken(darkColor, 2.0);
    ...
    group('Color Generation', () {
      test('generateHarmoniousColors returns 5 colors', () {
        ...
        expect(harmonious.every((color) => color is Color), isTrue);
      });
    ...
    group('Edge Cases', () {
      ...
      test('handles extreme values', () {
        ...
        final extremeLight = M3ColorUtils.lighten(color, 10.0);
        final extremeDark = M3ColorUtils.darken(color, 10.0);
      ...
      test('blendColors handles edge ratios', () {
        ...
        final blend0 = M3ColorUtils.blendColors(color1, color2, 0.0);
        final blend1 = M3ColorUtils.blendColors(color1, color2, 1.0);
