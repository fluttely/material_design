...
const double _kActiveIndicatorScale = _kActiveIndicatorSize / _kContainerSize;
...
/// A Material Design 3 Expressive loading indicator with morphing shapes.
///
/// Displays an animated, morphing shape to indicate ongoing activity with
/// smooth transitions between predefined polygon shapes. The indicator
/// provides enhanced visual feedback through dynamic shape transformations,
/// scaling animations, and rotation effects.
///
/// ## Variants
///
/// There are two primary variants available:
///
/// - **Default (Non-contained)**: Active indicator appears without background
/// - **Contained**: Active indicator is displayed over a container surface
///
/// ## Shape Morphing
///
