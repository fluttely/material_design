...
class M3Radius extends Radius {
  ...
  const M3Radius._circular(M3CornerToken corner)
      : super.circular(
          corner == M3CornerToken.none
              ? M3Corners.none
  ...
  static const M3Radius zero = M3Radius._circular(M3CornerToken.none);
  ...
  static const extraSmall = M3Radius._circular(M3CornerToken.extraSmall);
  ...
  static const small = M3Radius._circular(M3CornerToken.small);
  ...
  static const medium = M3Radius._circular(M3CornerToken.medium);
  ...
  static const large = M3Radius._circular(M3CornerToken.large);
  ...
  static const extraLargeIncreased =
      M3Radius._circular(M3CornerToken.extraLargeIncreased);
  ...
  static const extraExtraLarge =
      M3Radius._circular(M3CornerToken.extraExtraLarge);
  ...
  static const full = M3Radius._circular(M3CornerToken.full);
}
