...
class M3Border extends Border {
  ...
  /// );
  /// ```
  const M3Border.all(M3BorderSide? side)
      : super(
          top: side ?? BorderSide.none,
          right: side ?? BorderSide.none,
          bottom: side ?? BorderSide.none,
          left: side ?? BorderSide.none,
        );
  ...
  static const M3Border extraThick = M3Border.all(M3BorderSide.extraThick);
}
