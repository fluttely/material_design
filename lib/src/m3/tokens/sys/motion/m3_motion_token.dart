...
enum M3MotionToken implements IM3Token<M3MotionScheme> {
  ...
  Curve get easing {
    return switch (this) {
      ...
      M3MotionToken.emphasizedIncoming => M3MotionEasingToken.emphasizedDecelerate.value,
      M3MotionToken.emphasizedOutgoing => M3MotionEasingToken.emphasizedAccelerate.value,
      M3MotionToken.standard => M3MotionEasingToken.standard.value,
      M3MotionToken.standardIncoming => M3MotionEasingToken.standardDecelerate.value,
      M3MotionToken.standardOutgoing => M3MotionEasingToken.standardAccelerate.value,
