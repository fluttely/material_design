...
enum M3ShapeToken implements IM3Token<RoundedRectangleBorder> {
  ...
  BorderRadius get borderRadius {
    return switch (this) {
      ...
      M3ShapeToken.extraLargeIncreased =>_M3BorderRadiusToken.extraLargeIncreased.value,
      M3ShapeToken.extraExtraLarge => _M3BorderRadiusToken.extraExtraLarge.value,
