...
/// IM3Token<TextStyle> textToken = M3TextStyleToken.bodyLarge;
/// ```
///
...
abstract interface class IM3Token<T> {
  ...
  ///
  /// // For color tokens
  /// Color color = M3SysColor.primary.value; // Color instance
  ///
  /// // For text style tokens
  /// TextStyle style = M3TextStyleToken.bodyLarge.value; // TextStyle instance
  /// ```
  T get value;
}
