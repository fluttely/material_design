...
// /// final shadows = M3Shadows.fromElevation(M3ElevationToken.level3);
// ///
// /// // Apply to container
// /// Container(
...
// enum M3Shadows implements IM3Token<List<BoxShadow>> {
//   /// Level 0: No shadow.
...
//   const M3Shadows(this.value);

//   /// Returns a shadow token for a given M3ElevationToken.
//   /// This method now delegates the logic to fromElevationValue.
//   factory M3Shadows.fromElevationToken(IM3ElevationToken elevation) =>
//       M3Shadows.fromElevation(elevation.value);

//   /// Returns a shadow token for a given elevation value in dp.
//   /// This method contains the core logic and is the single source of truth.
//   factory M3Shadows.fromElevation(double value) => switch (value) {
//         >= 12 => level5,
//         >= 8 => level4,
//         >= 6 => level3,
//         >= 3 => level2,
