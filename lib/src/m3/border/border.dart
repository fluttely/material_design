...
class M3Border extends Border {
  /// Creates a border with custom sides.
  const M3Border({
  ...
  /// Creates a border where all sides share the same [side] configuration.
  ...
  M3Border.all({
    ...
    M3BorderWidthValue width = M3BorderWidths.thin,
          ...
          M3BorderSide(outlineColor: outlineColor, width: width),
        );
