...
//               subtitle: 'Minimum 48x48dp touch targets for all interactive elements',
...
//         const SizedBox(width: M3Spacing.space8),
//         _buildStatChip('Screen Reader', Icons.record_voice_over, colorScheme.tertiary),
//       ],
//     );
//   }
...
//             ),
//           ),
//           description: 'Touch target de 48x48dp - fácil de tocar para todos os usuários',
//         ),
...
//             ),
//           ),
//           description: 'Touch target de apenas 24x24dp - difícil de tocar com precisão',
//         ),
...
//                 mainAxisAlignment: MainAxisAlignment.spaceEvenly,
//                 children: [
//                   Text('32dp\n(Pequeno)', textAlign: TextAlign.center, style: Theme.of(context).textTheme.bodySmall),
//                   Text('48dp\n(Mínimo)', textAlign: TextAlign.center, style: Theme.of(context).textTheme.bodySmall),
//                   Text('56dp\n(Ideal)', textAlign: TextAlign.center, style: Theme.of(context).textTheme.bodySmall),
//                 ],
//               ),
//             ],
//           ),
...
//             ),
//           ),
//           description: 'Screen reader lerá: "Adicionar produto aos favoritos, toque duas vezes para adicionar"',
//         ),
...
//             icon: const Icon(Icons.favorite_border),
//           ),
//           description: 'Screen reader lerá apenas: "Botão" - não é claro qual a função',
//         ),
...
//                     const SizedBox(height: M3Spacing.space8),
//                     Text('Carregando... 75%', style: Theme.of(context).textTheme.bodySmall),
//                   ],
//                 ),
//               ),
...
//               Semantics(
//                 label: _enableNotifications ? 'Notificações ativadas' : 'Notificações desativadas',
//                 hint: 'Toque duas vezes para alternar',
//                 child: SwitchListTile(
//                   title: const Text('Notificações'),
//                   value: _enableNotifications,
//                   onChanged: (value) => setState(() => _enableNotifications = value),
//                   secondary: Icon(_enableNotifications ? Icons.notifications : Icons.notifications_off),
//                 ),
//               ),
//             ],
//           ),
