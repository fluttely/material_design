...
class ShadowSystemTokens {
  ...
  static final elevation0 = SystemToken<List<BoxShadow>>(
    const [],
    'shadow.elevation0',
  ...
  static final elevation1 = SystemToken<List<BoxShadow>>(
    [
      BoxShadow(
        ...
        blurRadius: 2,
        spreadRadius: 0,
        color: Color.fromRGBO(0, 0, 0, ShadowOpacityReferenceTokens.umbra.value),
      ),
      BoxShadow(
        offset: const Offset(0, 1),
        blurRadius: 3,
        spreadRadius: 1,
        color: Color.fromRGBO(0, 0, 0, ShadowOpacityReferenceTokens.penumbra.value),
      ),
    ],
    'shadow.elevation1',
...
extension ElevationContext on BuildContext {
  ...
  CardElevationTokens get cardElevation => CardElevationTokens(); // error: The class 'CardElevationTokens' doesn't have an unnamed constructor.
// Try using one of the named constructors defined in 'CardElevationTokens'.
